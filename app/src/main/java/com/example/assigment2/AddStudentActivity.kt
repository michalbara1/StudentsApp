...
class AddStudentActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val saveMassegeTextView: TextView= findViewById(R.id.add_student_activity_save_messeage_textView)
        ...
        saveButton.setOnClickListener({
            saveMassegeTextView.text="Name:${nameEditText.text} ID:${idEditText.text}  is saved"
        })
